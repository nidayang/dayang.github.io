...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: "nidayang/nidayang.github.io", // 导航栏右侧生成Github链接
    ...
    author: {
      name: "dayang", // 必需
      link: "https://github.com/nidayang", // 可选的
    },
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          iconClass: "icon-erji",
          title: "听音乐",
          link: "https://music.163.com/#/my/m/music/playlist?id=447595473",
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'Da Yang | <a href="https://github.com/nidayang/nidayang.github.io/blob/main/LICENSE">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
